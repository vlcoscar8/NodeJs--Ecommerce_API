...
const swaggerSpec = {
    definition: {
        ...
        servers: [
            {
                url: `https://ecommerce-sneakers-api.herokuapp.com/`, // The URL of the api
            },
        ],
    },
...
server.all("/", (req, res) => {
    ...
    <div style="display: flex; flex-direction: column; justify-content: center; align-items: center">
        ...
        <h2>Documentation:</h2>
        <a href="https://ecommerce-sneakers-api.herokuapp.com/api-doc/" target="_blank">Sneakers Ecommerce api documentation</a>
